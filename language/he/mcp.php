...
$lang = array_merge($lang, array(
	...
	'MCP_QUEUE_DELETED_POSTS_EXPLAIN'		=> 'זוהי רשימה של כל ההודעות שנמחקו זמנית. אתה יכול לשחזר או למחוק הודעות לתמיד ממסך זה.',
	'MCP_QUEUE_DELETED_TOPICS'				=> 'נושאים שנמחקו',
	'MCP_QUEUE_DELETED_TOPICS_EXPLAIN'		=> 'זוהי רשימה של כל הנושאים שנמחקו זמנית. אתה יכול לשחזר או למחוק נושאים לתמיד ממסך זה.',

	'MCP_VIEW_USER'			=> 'הצג אזהרות עבור משתמש מסוים',
	...
	'MERGE_TOPIC_EXPLAIN'	=> 'במילוי הטופס הנמצא מטה תוכל להעביר הודעות לנושא אחר. ההודעות יפוצלו מנושא זה וימזגו לנושא אחר. סדר ההודעות לא ישתנה ויופיע כאילו שהמשתמשים פרסמו אותם בנושא חדש.<br />אנא בחר את מספר הזיהוי של הנושא או לחץ על “בחר נושא” בכדי לחפש את הנושא המבוקש.',
	...
	'NO_POSTS_DELETED'				=> 'אין הודעות שנמחקו.',
	'NO_POSTS_QUEUE'				=> 'אין הודעות שמחכות לאישור.',
	...
	'NO_TOPICS_DELETED'				=> 'אין נושאים שנמחקו.',
	'NO_TOPICS_QUEUE'				=> 'אין נושאים שמחכים לאישור.',

	'ONLY_TOPIC'			=> 'רק נושא “%s”',
	'OTHER_USERS'			=> 'משתמשים אחרים שפרסמו הודעות מ IP זה',

	'QUICKMOD_ACTION_NOT_ALLOWED' => "%s לא ניתן להפעלה במצב מהיר",

	'PM_REPORT_CLOSED_SUCCESS'	=> 'הדיווח על ההודעה הפרטית נסגר בהצלחה.',
	'PM_REPORT_DELETED_SUCCESS'	=> 'הדיווח על ההודעה הפרטית נמחק בהצלחה.',
	'PM_REPORTED_SUCCESS'		=> 'ההודעה הפרטית דווחה בהצלחה.',
	'PM_REPORTS_CLOSED_SUCCESS'	=> 'הדיווחים על ההודעות הפרטיות נסגרו בהצלחה.',
	'PM_REPORTS_DELETED_SUCCESS'=> 'הדיווחים על ההודעות הפרטיות נמחקו בהצלחה.',
	'PM_REPORTS_TOTAL'			=> array(
		0	=> 'אין הודעות פרטיות שצריך לבדוק.',
		1	=> 'בסך, קיימת הודעה פרטית <strong>אחת</strong> לבדיקה.',
		2	=> 'בסך הכל יש <strong>%d</strong> הודעות פרטיות לבדיקה.',
	),
	...
	'POSTS_RESTORED_SUCCESS'	=> 'ההודעות שנבחרו שוחזרו בהצלחה.',
	...
	'POST_RESTORED_SUCCESS'		=> 'הודעה זו שוחזרה בהצלחה.',
	...
	'REPORTS_TOTAL'				=> array(
		0	=> 'אין דיווחים חדשים.',
		1	=> 'בסך הכל, יש דיווח <strong>אחד</strong> לבדיקה.',
		2	=> 'בסך הכל, יש <strong>%d</strong> דיווחים לבדיקה.',
	),
	...
	'RESTORE'					=> 'שחזור',
	'RESTORE_POST'				=> 'שחזר הודעה',
	'RESTORE_POST_CONFIRM'		=> 'אתה בטוח שברצונך לשחזר את ההודעה שנבחרה?',
	'RESTORE_POSTS'				=> 'שחזר הודעות',
	'RESTORE_POSTS_CONFIRM'		=> 'אתה בטוח שברצונך לשחזר את ההודעות שנבחרו?',
	'RESTORE_TOPIC'				=> 'שחזר נושא',
	'RESTORE_TOPIC_CONFIRM'		=> 'אתה בטוח שברצונך לשחזר את הנושא שבחרת?',
	'RESTORE_TOPICS'			=> 'שחזר נושאים',
	'RESTORE_TOPICS_CONFIRM'	=> 'אתה בטוח שברצונך לשחזר את הנושאים שנבחרו?',
	'RESYNC'					=> 'חדש',
	...
	'SPLIT_AFTER'						=> 'פצל נושא החל מההודעה שנבחרה',
	...
	'TOPICS_RESTORED_SUCCESS'	=> 'הנושאים שנבחרו שוחזרו בהצלחה.',
