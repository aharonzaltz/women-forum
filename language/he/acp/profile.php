...
$lang = array_merge($lang, array(
	...
	'HIDE_PROFILE_FIELD_EXPLAIN'	=> 'הסתר את שדה הפרופיל מכל המשתמשים מלבד המשתמש, מנהלים ראשיים, ומנהלים אשר עדיין יכולים לצפות בשדה זה. אם הצג בלוח הבקרה למשתמש מבוטל, המשתמש לא יוכל לראות או לערוך את שדה זה ורק המנהל הראשי יוכל לערוך את שדה זה.',
