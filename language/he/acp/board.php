...
$lang = array_merge($lang, array(
	...
	'DISPLAY_UNAPPROVED_POSTS'		=> 'הצג נושאים שלא אושרו למורשה המערכת',
	'DISPLAY_UNAPPROVED_POSTS_EXPLAIN'	=> 'נושאים שטרם אושרו ניתנים לצפייה על-ידי מורשה המערכת. אינו חל על נושאים של אורחים.',
...
$lang = array_merge($lang, array(
	...
	'ALLOW_REMOTE_EXPLAIN'			=> 'סמלים אישיים המקושרים מאתר אחר. <br><em><strong class="error">אזהרה:</strong> הפעלת אפשרות זו עשויה לאפשר למשתמשים לבחור קבצים ושירותים שזמינים בשרת המקומי בלבד.</em>',
	'ALLOW_REMOTE_UPLOAD'			=> 'אפשר העלאת סמלים אישיים מרוחקים',
	'ALLOW_REMOTE_UPLOAD_EXPLAIN'	=> 'אפשר העלאת סמלים אישיים מאתר אחר. <br><em><strong class="error">אזהרה:</strong> הפעלת אפשרות זו עשויה לאפשר למשתמשים לבחור קבצים ושירותים שזמינים בשרת המקומי בלבד.</em>',
	'ALLOW_REMOTE_UPLOAD_EXPLAIN'	=> 'אפשר העלאת סמלים אישיים מאתר אחר. <br><em><strong class="error">אזהרה:</strong> הפעלת אפשרות זו עשויה לאפשר למשתמשים לבחור קבצים ושירותים שזמינים בשרת המקומי בלבד.</em>',
...
//	'ACC_USER_ADMIN'			=> 'User + Admin',
	...
	'PASSWORD_LENGTH_EXPLAIN'	=> 'מספר התוים המינימלי בסיסמה. שים לב כי אין הגבלה לכמות תוים מקסימלית.',
...
$lang = array_merge($lang, array(
	...
	'COOKIE_DOMAIN_EXPLAIN'		=> 'במרבית המקרים כתובת העוגיה היא אופציונאלית. השאר ריק אם אתה לא בטוח.',
	'COOKIE_NAME'				=> 'שם העוגייה',
	'COOKIE_NAME_EXPLAIN'		=> 'השם יכול להיות כל דבר שתרצה, רק בחר במשהו מקורי. בכל פעם שהגדרות העוגייה משתנות, צריך גם לשנות את שם העוגייה.',
...
$lang = array_merge($lang, array(
	...
	'CONTACT_US_ENABLE_EXPLAIN'		=> 'העמוד הזה מאפשר למשתמשים לשלוח דואר אלקטרוני למנהלים הראשיים של המערכת, שים לב שהאפשרות לשליחת מיילים במערכת צריכה להיות מופעלת כדי שאפשרות זו תעבוד. אפשרות זו מופיעה בתפריט כללי > תקשורות לקוחות > דואר אלקטרוני.',
...
$lang = array_merge($lang, array(
	...
	'LOAD_USER_ACTIVITY_LIMIT'		=> 'הגבל הצגת פעילות משתמש לפי הודעות',
	'LOAD_USER_ACTIVITY_LIMIT_EXPLAIN'	=> 'הנושא/פורום פעיל לא יוצג עבור משתמשים עם מספר הודעות גדול מממספר זה. קבע כ-0 כדי לבטל את המגבלה.',
	...
	'YES_ACCURATE_PM_BUTTON'			=> 'אפשר הצגת חיווי הודעות פרטיות מדויק בעמודי הנושאים',
	'YES_ACCURATE_PM_BUTTON_EXPLAIN'	=> 'אם אפשרות זו מופעלת, רק משתמשים בעלי הרשאה לקריאת הודעות פרטיות יהיו בעלי כפתור שמאפשר למשתמשים אחרים לשלוח להם הודעה פרטית בעמודי הנושאים.',
...
$lang = array_merge($lang, array(
	...
	'APACHE_SETUP_BEFORE_USE'	=> 'אתה צריך להתקין אימות apache לפני שתחליף את phpBB3 לשיטת אימות זו. זכור ששם המשתמש שלך לאימות apache חייב להיות זהה לשם המשתמש שלך ב־phpBB3. אימות Apache ניתן לשימוש רק עם mod_php (לא עם גרסת CGI).',
...
$lang = array_merge($lang, array(
	...
	'MOD_REWRITE_INFORMATION_UNAVAILABLE' => 'אין באפשרותנו לקבוע האם השרת תומך בשינוי כתובת URL. אתה יכול להפעיל את ההגדרה, אך במידה ואפשרות זה לא נתמכת, נתיבים שיוספקו על ידי המערכת (וכן השימוש בקישורים) לא יעבוד. צור קשר עם בעל האחסון, אם אתה לא בטוח האם אתה יכול להשתמש באפשרות זו בביטחון.',
...
$lang = array_merge($lang, array(
	...
	'ADMIN_EMAIL'					=> 'דואר אלקטרוני לתגובה',
	'ADMIN_EMAIL_EXPLAIN'			=> 'כתובת הדואר האלקטרוני ממנה נשלחים מיילים מהאתר, משמש גם ככתובת הדואר האלקטרוני ליצירת קשר. תמיד בשימוש בתור כתובת <samp>נתיב תשובה</samp> ו־<samp>שולח</samp> בהודעות דואר אלקטרוני.',
	...
	'EMAIL_FORCE_SENDER'			=> 'כתובת דואר אלקטרוני מאולצת',
	...
	'EMAIL_MAX_CHUNK_SIZE'			=> 'מספר מירבי של אימיילים הניתנים לקבלה',
	'EMAIL_MAX_CHUNK_SIZE_EXPLAIN'	=> 'אם נדרש, קבע מספר מירבי שלא יהיה ניתן לחצותו ששרת האימייל שלך יאפשר בהודעת אימייל אחת.',
	...
	'SMTP_SERVER_EXPLAIN'			=> 'אל תזין פרוטוקול (<samp>ssl://</samp> או <samp>tls://</samp>) אלא אם שרת האימייל שלך דורש זאת.',
	'SMTP_SETTINGS'					=> 'הגדרות SMTP',
	'SMTP_USERNAME'					=> 'שם משתמש ל־SMTP',
	'SMTP_USERNAME_EXPLAIN'			=> 'הזן שם משתמש רק אם שרת ה־SMTP שלך דורש זאת.',
	'SMTP_VERIFY_PEER'				=> 'אימות תעודת SSL',
	...
	'SMTP_VERIFY_PEER_NAME'			=> 'אימות שם משתמש SMTP',
