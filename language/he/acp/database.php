...
$lang = array_merge($lang, array(
	'ACP_BACKUP_EXPLAIN'	=> 'מעמוד זה ניתן לגבות את בסיס הנתונים של phpBB. הגיבוי יאוחסן בתקיית  <samp>store/</samp> או להוריד אותה ישירות. לפי הגדרות השרת שלך, תוכל לדחוס את הקובץ במספר שיטות דחיסה.',
	...
	'BACKUP_NOT_SUPPORTED'	=> 'הקובץ הנבחר לגיבוי אינו נתמח',
